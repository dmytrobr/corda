...
fun mainPortAllocation(): PortAllocation = testPortAllocation(FileLockPortAllocation.MAIN, 10000)
fun debugPortAllocation(): PortAllocation = testPortAllocation(FileLockPortAllocation.DEBUG, 5005)
